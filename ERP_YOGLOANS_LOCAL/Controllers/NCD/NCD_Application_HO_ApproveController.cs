...
{
    public class NCD_Application_HO_ApproveController : Controller
    {
        DB dbconnect = new DB();
        public ActionResult NCD_Application_HO_Approve_View()
        {
        ...
        public JsonResult Approve_BtnClick(string renew_amount)
        {
            ...
            dbconnect.Open();
            dbconnect.ExecuteDataset("[dbo].[DEB_application_HO_approval]", pr);
            dbconnect.Close();
