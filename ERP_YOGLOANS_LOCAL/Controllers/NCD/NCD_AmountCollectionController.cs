...
{
    public class NCD_AmountCollectionController : Controller
    {
        DB dbconnect = new DB();
        FileCompressor doc = new FileCompressor();

        doc_compression ImageCompress = new doc_compression();
        public ActionResult NCD_AmountCollection_view()
        {
        ...
        private DataTable Collection_Customer_Grid()
        {
            ...
            dbconnect.Open();
            dt = dbconnect.ExecuteDataset("[dbo].[DEB_AmountCollection]", pr).Tables[0];
            dbconnect.Close();
            return dt;
        }
        ...
        public ActionResult Add_Btn_click(FormCollection form, HttpPostedFileBase bank_attachment)
        {
            try
            {
                ...
                dbconnect.Open();
                dt = dbconnect.ExecuteDataset("[dbo].[DEB_AmountCollection]", pr11).Tables[0];
                dbconnect.Close();
        ...
        public ActionResult submit_Btn_click( )
        {
            ...
            dbconnect.Open();
            dbconnect.ExecuteDataset("[dbo].[DEB_AmountCollection]", pr11);
            dbconnect.Close();
