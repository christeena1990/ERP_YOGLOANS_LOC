...
{
    public class NCD_monthly_interest_approvalController : BaseController
    {
        DB dbconnect = new DB();
        // GET: NCD_monthly_interest_approval
        public ActionResult NCD_monthly_interest_approval()
        {
        ...
        public DataTable fillissuedropdown()
        {
            ...
            pr[0].Value = 3;
            dt = dbconnect.ExecuteDataset("[dbo].[DEB_int_payment_approve]", pr).Tables[0];
            dbconnect.Close();
            return dt;
        ...
        public JsonResult GetgridData(int bankId, int? issueNo = null)
        {
            ...
            try
            {
                ...
                pr[0] = new SqlParameter("@query_id", SqlDbType.Int) { Value = 1 };
                pr[1] = new SqlParameter("@brbranch", SqlDbType.BigInt) { Value = bankId };
                ...
                DataSet ds = dbconnect.ExecuteDataset("[dbo].[ncd_monthly_int_approve]", pr);
        ...
        public ActionResult btn_reject_Click()
        {
            SqlParameter[] pr = new SqlParameter[6];
            {
                ...
                dbconnect.ExecuteStoredProcedure("[dbo].[ncd_monthly_int_approve]", pr);
