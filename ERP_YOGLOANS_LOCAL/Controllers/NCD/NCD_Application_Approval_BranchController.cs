...
{
    public class NCD_Application_Approval_BranchController : Controller
    {
        DB dbconnect = new DB();
        public ActionResult NCD_Application_Approval_Branch_View()
        {
          
            var customerBankDetails = NCD_Approval_Grid();
        ...
        private DataTable NCD_Approval_Grid()
        {
            ...
            dbconnect.Open();
            dt = dbconnect.ExecuteDataset("[dbo].[DEB_branch_approval]", pr).Tables[0];
            dbconnect.Close();
        ...
        public JsonResult amount_colle_attach_popup(string hiddenValue)
        {
            ...
            {
                model.ImageUrl3 = GetImageUrl(dt.Rows[0]["attachment_data"] as byte[]);
        ...
        public JsonResult Approve_BtnClick(string renew_amount)
        {
            ...
            pr[3] = new SqlParameter("@renew_amt", SqlDbType.VarChar, 100) { Value = renew_amount };
