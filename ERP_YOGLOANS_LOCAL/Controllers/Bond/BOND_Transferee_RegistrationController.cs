...
{
    public class BOND_Transferee_RegistrationController : Controller
    {
        DB dbconnect = new DB();
        public ActionResult BOND_Transferee_Registration_View()
        {
            ...
            if (Session["application_custId_161"] != null)
            {
        ...
        public DataSet Applicantdetails()
        {
            ...
            pr[1].Value = Session["application_custId_161"]; // Ensure branch_id is converted to an integer
        ...
        public JsonResult FillDropdowns()
        {
            ...
            pr2[1].Value = Session["application_custId_161"].ToString();
            ...
            dbconnect.Open();
            ds = dbconnect.ExecuteDataset("BOND_Application", pr2);
            dbconnect.Close();
        ...
        {
            Session["application_custId_161"] = null;
            Session["application_subid"] = "0";
            SqlParameter[] pr2 = new SqlParameter[17];
            ...
            pr2[12] = new SqlParameter("@pancard", SqlDbType.VarChar, 20);
            pr2[12].Value = submit_NCD_Application.pancard;

            pr2[13] = new SqlParameter("@nominee", SqlDbType.VarChar, 100);
            pr2[13].Value = submit_NCD_Application.nominee;

            pr2[14] = new SqlParameter("@nominee_add", SqlDbType.VarChar, 200);
            pr2[14].Value = submit_NCD_Application.nominee_add;

            pr2[15] = new SqlParameter("@relation", SqlDbType.VarChar, 50);
            pr2[15].Value = submit_NCD_Application.relation;

            pr2[16] = new SqlParameter("@outmsg", SqlDbType.VarChar, 500);
            pr2[16].Direction = ParameterDirection.Output;

            dbconnect.Open();
            dbconnect.ExecuteDataset("BOND_transfer_save", pr2);
            dbconnect.Close();

            string message = pr2[16].Value.ToString();
