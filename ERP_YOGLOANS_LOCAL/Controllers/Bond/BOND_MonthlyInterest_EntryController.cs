...
{
    public class BOND_MonthlyInterest_EntryController : BaseController
    {
        DB dbconnect = new DB();
        // GET: BOND_MonthlyInterest_Entry
        public ActionResult BOND_MonthlyInterest_Entry()
        {
        ...
        public DataTable fillissuedropdown()
        {
            ...
            pr[0].Value = 2;
            dt = dbconnect.ExecuteDataset("[dbo].[BOND_int_payment]", pr).Tables[0];
            dbconnect.Close();
            return dt;
...

        {
            try
            {
                ...
                DataSet ds = dbconnect.ExecuteDataset("[dbo].[BOND_int_payment]", pr);
        ...
        public ActionResult Bond_MonthlyInterestEntry_pdf()
        {
            ...
            return new ViewAsPdf("BOND_MonthlyInterestEntry_pdf")
            {
                FileName = "MonthlyInterest.pdf",
        ...
        public ActionResult btn_save_Click(string month, long issueNo, long cert, long bank_branch)
        {
            ...
            dbconnect.ExecuteStoredProcedure("[dbo].[BOND_int_payment]", pr);
