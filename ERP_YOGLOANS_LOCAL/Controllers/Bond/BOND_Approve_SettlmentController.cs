...
{
    public class BOND_Approve_SettlmentController : Controller
    {
        DB dbconnect = new DB();
        public ActionResult BOND_Approve_Settlment_View()
        {
        ...
        public JsonResult GetCategories()
        {
            ...
            try
            {
                ...
                parameters[0] = new SqlParameter("@query_id", SqlDbType.BigInt) { Value = 8 };
                parameters[1] = new SqlParameter("@branch_id", SqlDbType.BigInt) { Value = Session["branch_id"] ?? 0 };

                dbconnect.Open();
                DataSet categoryDataSet = dbconnect.ExecuteDataset("[dbo].[BOND_settlement_queries]", parameters);
                dbconnect.Close();
        ...
        public async Task<ActionResult> Approve_BtnClick(Disbursement_model disbursement_Model)
        {
            ...
            string benf_BankName = disbursement_Model.bankName;

            SqlParameter[] pr = new SqlParameter[6];

            pr[0] = new SqlParameter("branchbank", SqlDbType.BigInt);
            ...
            dbconnect.Open();
            dbconnect.ExecuteDataset("[dbo].[BOND_settlement_approval_save]", pr);
            dbconnect.Close();
        ...
        public JsonResult FillDropdowns()
        {
            ...
            dbconnect.Open();
            DataTable dt_type = dbconnect.ExecuteDataset("BOND_settlement_queries", pr2).Tables[0];
            dbconnect.Close();
            ...
            dbconnect.Open();
            DataTable dt_mode = dbconnect.ExecuteDataset("BOND_settlement_queries", pr3).Tables[0];
            dbconnect.Close();
