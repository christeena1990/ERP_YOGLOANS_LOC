...
{
    public class Bond_Application_MoneyReceievedController : BaseController
    {
        DB dbconnect = new DB();


        // GET: Bond_Application_MoneyReceieved
        public ActionResult Bond_Application_MoneyReceieved()
        {
            //bankdropdown();
...

        {
            ...
            dbconnect.ExecuteStoredProcedure("[dbo].[BOND_application_HO_save]", pr);
            ...
            //else
            //{
            //    // Return error message if outputMessage is not "Submit successfully"
