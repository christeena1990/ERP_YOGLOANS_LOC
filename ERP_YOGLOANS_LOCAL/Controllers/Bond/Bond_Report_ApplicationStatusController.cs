...
{
    public class Bond_Report_ApplicationStatusController : Controller
    {
        // GET: NCD_Report_ApplicationStatus

        DB dbconnect = new DB();
        // GET: PL_Report_SanctionTracker
        public ActionResult Bond_Report_ApplicationStatus()
        {
        ...
        public ActionResult btn_report_Click(string fromDate, string toDate, int StageType)
        {
            try
            {
                ...
                var result = dt.AsEnumerable().Select(row => new
                {
                    ...
                    bond_amount = row["bond_amount"] != DBNull.Value ? Convert.ToString(row["bond_amount"]) : null,
        ...
        public ActionResult Bond_Applicationstatusreport_pdf()
        {
            ...
            return new ViewAsPdf("Bond_Applicationstatusreport_pdf")
            {
