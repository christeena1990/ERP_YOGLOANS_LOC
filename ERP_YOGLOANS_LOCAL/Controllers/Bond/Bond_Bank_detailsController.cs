...
{
    public class Bond_Bank_detailsController : Controller
    {
        ...
        DB dbconnect = new DB();
        public ActionResult Bond_Bank_details_View()
        {
        ...
        public ActionResult submit_form_1(string customerName, string ifsc_code, string bankName, string branchName, string accountNo, HttpPostedFileBase file, string bank_id, string firstCellValue)
        {
            ...
            try
            {
                ...
                pr[2] = new SqlParameter("@app_id", SqlDbType.BigInt) { Value = firstCellValue };
                ...
                dbconnect.ExecuteDataset("[dbo].[BOND_CustomerBank]", pr);
                                  ...
                                  string bank_id1, string bank_id2, string applicationid)
        {
            ...
            try
            {
                ...
                pr[3] = new SqlParameter("@app_id", SqlDbType.BigInt) { Value = applicationid };
