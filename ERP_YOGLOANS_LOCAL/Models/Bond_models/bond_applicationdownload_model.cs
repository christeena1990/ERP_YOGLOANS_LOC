...
namespace ERP_YOGLOANS_LOCAL.Models.Bond_models
{
    ...
    public class DataFillViewModel
    {
        ...
        public string repayment_payee_name { get; set; }
        public string repayment_banki_ac { get; set; }

        public string repayment_ifsc_code { get; set; }
        public string repayment_bank_name { get; set; }
        public string repayment_branch_name { get; set; }

        public string interest_payee_name { get; set; }
        public string interest_banki_ac { get; set; }

        public string interest_ifsc_code { get; set; }
        public string interest_bank_name { get; set; }
        public string interest_branch_name { get; set; }
